...
{
    public partial class RepTraspasoCajas : Form
    {
        OTraspasoCaja TCaj = null;

        public RepTraspasoCajas(OTraspasoCaja tcaj)
        {
            InitializeComponent();
        ...
        private void RepTraspasoCajas_Load(object sender, EventArgs e)
        {
            try
            {
                ...
                OTraspasoCajaBindingSource.DataSource = TCaj;
            }
            catch (Exception ex)
            {
